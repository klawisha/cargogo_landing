...
const I18N = {
  en: {
    ...
    "about.label":"FOUNDER","about.bio":"CargoGo is being built as a technology-first marketplace: simple for the user, rigorous underneath. Product, engineering, trust workflows and the initial platform architecture are developed around one goal — make cargo transportation easier to arrange and easier to understand.","about.contact":"Contact / Support",
  ...
  uk: {
    ...
    "about.label":"ЗАСНОВНИК","about.bio":"CargoGo створюється як технологічний маркетплейс: простий для користувача і строгий усередині. Продукт, розробка, trust-процеси та базова архітектура платформи підпорядковані одній меті — зробити організацію перевезення простішою й зрозумілішою.","about.contact":"Контакт / Підтримка",
  ...
  ru: {
    ...
    "about.label":"ОСНОВАТЕЛЬ","about.bio":"CargoGo создаётся как технологический маркетплейс: простой для пользователя и строгий внутри. Продукт, разработка, trust-процессы и базовая архитектура платформы подчинены одной цели — сделать организацию перевозки проще и понятнее.","about.contact":"Контакт / Поддержка",
