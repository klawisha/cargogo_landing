...
Object.assign(I18N.en,{
  ...
  "cult.p1":"During World War II, remote Pacific islands became part of huge military supply chains. Aircraft brought food, tools, machinery and other goods. When the bases closed and the flights stopped, that flow of cargo disappeared almost overnight.",
  "cult.p2":"Some Melanesian movements interpreted that sudden material world through local religious and political ideas. Popular accounts describe symbolic airstrips, observation towers, signal fires and aircraft-like constructions intended to recreate the visible signs that had accompanied the arrival of cargo.",
  "cult.p3":"The best-known version of the story says that people built straw or wooden model aircraft, cleared landing grounds and lit fires in the hope that the planes — and the goods they carried — would return. That image is a simplified shorthand for much more varied and complex histories, but it is where the modern phrase “cargo cult” became widely recognizable.",
  "cult.card1":"Model aircraft","cult.card1Text":"Symbolic planes made from local materials echoed the machines people had watched arrive from overseas.",
  "cult.card2":"Landing grounds","cult.card2Text":"Cleared strips and lines of lights recreated the visual language of wartime airfields.",
  "cult.card3":"Towers & signals","cult.card3Text":"Wooden towers, torches and signals imitated parts of the infrastructure associated with arriving aircraft.",
  "cult.brandKicker":"THE NAME, NOT THE RITUAL","cult.brand":"CargoGo takes the memorable idea in a simpler direction: cargo should move because the route and the deal work.",
  "cult.tagline":"Cargo, moving.","cult.close":"Close",
  "cult.note":"“Cargo cult” is a real anthropological term. The model-aircraft and runway story is a popular summary of more diverse Melanesian movements and should not be read as a complete description of them.",
...
Object.assign(I18N.uk,{
  ...
  "cult.p1":"Під час Другої світової війни віддалені острови Тихого океану стали частиною величезних військових ланцюгів постачання. Літаки привозили їжу, інструменти, техніку та інші речі. Коли бази закрилися і польоти припинилися, цей потік вантажів майже миттєво зник.",
  "cult.p2":"Деякі меланезійські рухи осмислювали раптову появу нового матеріального світу через місцеві релігійні та політичні уявлення. У популярних переказах згадуються символічні злітні смуги, спостережні вежі, сигнальні вогні й конструкції, схожі на літаки, — відтворення зовнішніх ознак, що супроводжували прибуття cargo.",
  "cult.p3":"Найвідоміша версія історії розповідає, що люди робили солом’яні або дерев’яні макети літаків, розчищали майданчики для посадки й запалювали вогні в надії, що літаки — а разом із ними й товари — повернуться. Це спрощений образ значно різноманітніших і складніших історій, але саме через нього вислів «культ карго» став широко впізнаваним.",
  "cult.card1":"Макети літаків","cult.card1Text":"Символічні літаки з місцевих матеріалів повторювали форму машин, які люди бачили під час військових поставок.",
  "cult.card2":"Посадкові майданчики","cult.card2Text":"Розчищені смуги й лінії вогнів відтворювали знайомий образ польового аеродрому.",
  "cult.card3":"Вежі та сигнали","cult.card3Text":"Дерев’яні вежі, факели й сигнали наслідували інфраструктуру, пов’язану з прибуттям літаків.",
  "cult.brandKicker":"НАЗВА, А НЕ РИТУАЛ","cult.brand":"CargoGo бере з цієї історії лише назву: вантаж рухається тоді, коли працюють маршрут і домовленість.",
  "cult.tagline":"Вантаж у русі.","cult.close":"Закрити",
  "cult.note":"«Культ карго» — реальний антропологічний термін. Історія про макети літаків і злітні смуги є популярним узагальненням різноманітніших меланезійських рухів і не описує їх повністю.",
...
Object.assign(I18N.ru,{
  ...
  "cult.p1":"Во время Второй мировой войны отдалённые острова Тихого океана стали частью огромных военных цепочек снабжения. Самолёты привозили еду, инструменты, технику и другие вещи. Когда базы закрылись и полёты прекратились, этот поток грузов почти мгновенно исчез.",
  "cult.p2":"Некоторые меланезийские движения осмысляли внезапное появление нового материального мира через местные религиозные и политические представления. В популярных рассказах упоминаются символические взлётные полосы, наблюдательные вышки, сигнальные огни и конструкции, похожие на самолёты, — повторение внешних признаков, сопровождавших прибытие cargo.",
  "cult.p3":"Самая известная версия истории рассказывает, что люди делали соломенные или деревянные макеты самолётов, расчищали посадочные площадки и зажигали огни в надежде, что самолёты — а вместе с ними и товары — вернутся. Это упрощённый образ гораздо более разнообразных и сложных историй, но именно через него выражение «культ карго» стало широко узнаваемым.",
  "cult.card1":"Макеты самолётов","cult.card1Text":"Символические самолёты из местных материалов повторяли форму машин, которые люди видели во время военных поставок.",
  "cult.card2":"Посадочные площадки","cult.card2Text":"Расчищенные полосы и линии огней воспроизводили знакомый образ полевого аэродрома.",
  "cult.card3":"Вышки и сигналы","cult.card3Text":"Деревянные вышки, факелы и сигналы имитировали инфраструктуру, связанную с прибытием самолётов.",
  "cult.brandKicker":"НАЗВАНИЕ, НЕ РИТУАЛ","cult.brand":"CargoGo берёт из этой истории только название: груз движется, когда работают маршрут и договорённость.",
  "cult.tagline":"Груз в движении.","cult.close":"Закрыть",
  "cult.note":"«Культ карго» — реальный антропологический термин. История про макеты самолётов и взлётные полосы — популярное обобщение более разнообразных меланезийских движений и не является их полным описанием.",
...
(() => {
  ...
  const dismiss=document.getElementById('cultDismiss');
  ...
  if(scene && matchMedia('(pointer:fine)').matches && !matchMedia('(prefers-reduced-motion: reduce)').matches){
    scene.addEventListener('pointermove',e=>{
      ...
      scene.style.setProperty('--cult-x',`${x}px`);
      scene.style.setProperty('--cult-y',`${y}px`);
    });
    scene.addEventListener('pointerleave',()=>{scene.style.setProperty('--cult-x','0px');scene.style.setProperty('--cult-y','0px');});
  }
